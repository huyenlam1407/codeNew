/*********************************************************************************
	...
	Template Name: Belle - Multipurpose eCommerce Bootstrap4 cshtml Template
...
(function ($) {
	...
	$('[data-countdown]').each(function () {
		...
		$this.countdown(finalDate, function (event) {
			$this.cshtml(event.strftime('<span class="ht-count days"><span class="count-inner"><span class="time-count">%-D</span> <span>Days</span></span></span> <span class="ht-count hour"><span class="count-inner"><span class="time-count">%-H</span> <span>HR</span></span></span> <span class="ht-count minutes"><span class="count-inner"><span class="time-count">%M</span> <span>Min</span></span></span> <span class="ht-count second"><span class="count-inner"><span class="time-count">%S</span> <span>Sc</span></span></span>'));
		});
	});
	...
	function scroll_top(){
		$("#site-scroll").on("click", function() {
			$("cshtml, body").animate({ scrollTop: 0 }, 1000);
				return false;
		}); 
	}
	scroll_top();
	...
	$(".product-tabs li").on('click', function () {
		...
		$(this).fadeIn();
          ...
          $("cshtml, body").animate({ scrollTop: tabposition.top }, 700);
        }
	});
    ...
    $(".reviewLink").on('click', function(e){
      e.preventDefault();
        ...
        $(tab).fadeIn();
      	...
      	if($(window).width()<767) {
          $("cshtml, body").animate({ scrollTop: tabposition.top-50 }, 700);
        } else{
          $("cshtml, body").animate({ scrollTop: tabposition.top-80 }, 700);
        }
    });
	...
	function load_more(){
        ...
        $(".loadMore").on('click', function (e) {
            ...
            if ($(".product-load-more .item:hidden").length == 0) {
                $(".infinitpagin").cshtml('<div class="btn loadMore">no more products</div>');
            }
        });
    }
	load_more();
	...
	function load_more_post(){
        ...
        $(".loadMorepost").on('click', function (e) {
            ...
            if ($(".blog--grid-load-more .article:hidden").length == 0) {
                $(".loadmore-post").cshtml('<div class="btn loadMorepost">No more Blog Post</div>');
            }
        });
    }
	load_more_post();
